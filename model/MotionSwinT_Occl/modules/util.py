...
class Auto_Swin(nn.Module):
    ...
    def forward(self, x):
        ...
        up3 = self.up3[0](s4) # up3.shape = 16, 16, 384
        cn_skip3 = self.cn3[0](s3)
        merge34 = up3 + cn_skip3 # merge34.shape = 16, 16, 384
        outs.append(merge34)

        up2 = self.up2[0](merge34) # up2.shape = 32, 32, 192
        cn_skip2 = self.cn2[0](s2)
        merge23 = up2 + cn_skip2 # merge23.shape = 32, 32, 192
        outs.append(merge23)
        
        up1 = self.up1[0](merge23) # up1.shape = 64, 64, 96
        cn_skip1 = self.cn1[0](s1)
        merge12 = up1 + cn_skip1 # merge12.shape = 64, 64, 96
        outs.append(merge12)
...
class Hourglass_Swin(nn.Module):
    ...
    def __init__(self):
        ...
        self.out_filters = [786, 384, 192, 96]
