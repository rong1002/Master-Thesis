...
import torch
from .util import Hourglass_Swin, AntiAliasInterpolation2d, make_coordinate_grid, kp2gaussian
...
class DenseMotionNetwork(nn.Module):
    ...
    def __init__(self, block_expansion, num_blocks, max_features, num_kp, num_channels, estimate_occlusion_map=False, scale_factor=1, kp_variance=0.01):
        ...
        self.hourglass = Hourglass_Swin(block_expansion=block_expansion, in_features=(num_kp + 1) * (num_channels + 1),
